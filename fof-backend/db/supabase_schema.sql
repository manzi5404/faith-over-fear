...
INSERT INTO quality_levels (name, description, sort_order, is_active) VALUES
    ('Premium', 'Upgraded heavyweight fabric. Softer feel, reinforced seams, and a structured collar. Built to last longer.', 1, TRUE),
    ('Luxe', 'Premium combed cotton, ultra-soft handfeel, and precision tailoring. The highest quality construction for a premium look and feel.', 2, TRUE)
ON CONFLICT DO NOTHING;
