...
async function seedDrops() {
  try {
    ...
    const products = [
      { name: 'Origins Tee', slug: 'origins-tee', description: 'Premium heavyweight tee', images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400'], status: 'live' },
      { name: 'Origins Hoodie', slug: 'origins-hoodie', description: '400GSM heavyweight hoodie', images: ['https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400'], status: 'live' },
      { name: 'Origins Cap', slug: 'origins-cap', description: 'Embroidered structured cap', images: ['https://images.unsplash.com/photo-1588850561407-ed78c334e67a?w=400'], status: 'live' },
      { name: 'Origins Joggers', slug: 'origins-joggers', description: 'Relaxed-fit joggers', images: ['https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=400'], status: 'live' },
    ];
    ...
    for (const dropData of lookbookDrops) {
      ...
      const lookbookProducts = [
        { name: `${dropData.title} Tee`, slug: `${dropData.slug}-tee`, description: 'Classic fit tee', images: ['https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=400'], status: 'live' },
        { name: `${dropData.title} Cap`, slug: `${dropData.slug}-cap`, description: 'Structured cap', images: ['https://images.unsplash.com/photo-1588850561407-ed78c334e67a?w=400'], status: 'live' },
        { name: `${dropData.title} Hoodie`, slug: `${dropData.slug}-hoodie`, description: 'Heavyweight hoodie', images: ['https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400'], status: 'live' },
        { name: `${dropData.title} Shorts`, slug: `${dropData.slug}-shorts`, description: 'Relaxed-fit shorts', images: ['https://images.unsplash.com/photo-1591195853828-11db59a44f6b?w=400'], status: 'live' },
      ];
