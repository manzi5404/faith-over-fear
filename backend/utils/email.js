...
const dropDesc = description || 'Our latest collection has arrived. This is the fit.';
    const dropImage = image_url || 'https://placehold.co/600x400/000000/FFFFFF/png?text=DOTTIE.YZ+NEW+DROP';
    const shopUrl = process.env.CLIENT_URL || process.env.FRONTEND_URL || 'https://dottieyz.rw';
...
<h1 style="margin: 0; font-size: 42px; font-weight: 900; color: #fff; letter-spacing: -2px;">DOTTIE<span style="color: #60a5fa;">.</span>YZ</h1>
                                    <p style="margin: 8px 0 0; font-size: 11px; color: #60a5fa; text-transform: uppercase; letter-spacing: 4px; font-weight: 600;">This Is The Fit</p>
                                </td>
                            </tr>
...
<table role="presentation" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
<a href="https://www.instagram.com/dottie.yz/" style="display: inline-block; margin: 0 12px; color: #888; text-decoration: none; font-size: 12px;">Instagram</a>
                                                <span style="color: #60a5fa; margin: 0 8px;">|</span>
                                                <a href="mailto:dottieyz01@gmail.com" style="display: inline-block; margin: 0 12px; color: #888; text-decoration: none; font-size: 12px;">Contact</a>
                                            </td>
                                        </tr>
                                    </table>
                                    <p style="margin: 20px 0 0; font-size: 10px; color: #555; text-transform: uppercase; letter-spacing: 2px;">&copy; 2026 DOTTIE.YZ. Streetwear Reinvented.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
...
async function notifyLiveDrop(userEmails, dropDetails) {
    ...
    const shopUrl = process.env.CLIENT_URL || 'https://dottieyz.rw';

    const subject = `🔥 ${dropName} IS LIVE NOW!`;
    const html = `
<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #000; color: #fff; padding: 40px; text-align: center; border: 2px solid #60a5fa;">
            <h1 style="letter-spacing: -2px; font-size: 48px; margin-bottom: 0;">DOTTIE.YZ</h1>
            <p style="text-transform: uppercase; letter-spacing: 5px; font-size: 10px; color: #60a5fa; margin-top: 5px; font-weight: bold;">Drop Live Now</p>
            
            <div style="margin: 40px 0;">
                <img src="${dropImage}" alt="${dropName}" style="width: 100%; max-height: 400px; object-fit: cover; border: 1px solid #60a5fa;">
            </div>
            
            <h2 style="text-transform: uppercase; font-size: 32px; margin-bottom: 10px; color: #fff; font-weight: 900;">DROP IS LIVE.</h2>
            ...
            <a href="${shopUrl}/shop.html" style="background: #60a5fa; color: #000; text-decoration: none; padding: 20px 60px; font-weight: 900; text-transform: uppercase; font-size: 12px; letter-spacing: 4px; display: inline-block;">Shop Now</a>
            
            <div style="margin-top: 60px; padding-top: 30px; border-top: 1px solid #111; font-size: 10px; color: #60a5fa; text-transform: uppercase; letter-spacing: 2px;">
                &copy; 2026 DOTTIE.YZ. Streetwear Reinvented.
            </div>
        </div>
    `;
...
async function notifyReservation(userEmail, reservationData, productData) {
    ...
    const productImage = (productData?.image_urls && productData.image_urls.length > 0) ? productData.image_urls[0] : 'https://placehold.co/400x400?text=DOTTIE.YZ+Reservation';
    ...
    const html = `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #000; color: #fff; padding: 40px; text-align: center;">
            <h1 style="letter-spacing: -2px; font-size: 48px; margin-bottom: 0;">DOTTIE<span style="color: #60a5fa;">.</span>YZ</h1>
            <p style="text-transform: uppercase; letter-spacing: 5px; font-size: 10px; color: #60a5fa; margin-top: 5px;">This Is The Fit</p>
            ...
            <div style="margin-top: 60px; padding-top: 20px; border-top: 1px solid #222; font-size: 10px; color: #555; text-transform: uppercase; letter-spacing: 1px;">
                &copy; 2026 DOTTIE.YZ. Copy Is Faith. &rarr; Streetwear Reinvented.
            </div>
        </div>
    `;
