const fs = require('fs');
let content = fs.readFileSync('c:/Users/manzi/Documents/Projects/FOF/faith-over-fear/product.html', 'utf8');

const regex = /<div class="flex flex-col space-y-4">\s*<template x-if="product\.isWaitlist">.*?<\/template>\s*<\/div>\s*<\/template>\s*<\/div>/s;

const newBlock = `<div class="flex flex-col space-y-4">
                        <!-- Upcoming Status -->
...
fs.writeFileSync('c:/Users/manzi/Documents/Projects/FOF/faith-over-fear/product.html', content);
console.log("Done");
